...
const ModalDeleteProduct = () => {
    ...
    const handleDelete = async () =>{
        try {
            let res = await deleteProduct(productModal.product.id);
        ...
        <ContainerModal closeModal={handleCloseModal}>
            <div className="ModalDeleteProduct rounded-xl bg-white w-1/3 px-10 py-10 flex flex-col gap-8">
                <div className="flex justify-between items-center">
                    <p className="text-2xl font-bold text-red-600">Delete Product</p>
                ...
                <div>
                    ...
                    <div className="flex gap-2">
                        ...
                        <p className="text-gray-700">{productModal?.product.name}</p>
                    </div>
                    <div className="flex gap-2">
                        <p className="font-bold">Price: </p>
                        <p  className="text-gray-700">{productModal?.product.price}</p>
                    </div>
                </div>
